...
# client id: 750511791638-sgb38p5u0oac8e767t4i6jmr7dj9g3bu.apps.googleusercontent.com
# secret client: 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
...
def FormatUrlParams(params):
  ...
  for key,value in params.items():
    param_fragments.append(f'{key}={ UrlEscape(value)}')
...
def AuthorizeTokens(client_id, client_secret, authorization_code):
  ...
  response = request.urlopen(request_url, parse.urlencode(params).encode("utf-8")).read()
